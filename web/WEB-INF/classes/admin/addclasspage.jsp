...
<h2 style="text-align: center;color: darkgray;">增加班级</h2>
<form class="form-inline" role="form" style="text-align: center" action="AddClassAdmin" method="post">
    ...
    <div class="form-group">
        ...
        专业：<input type="text" class="form-control" id="major" name="major" placeholder="请输入专业" autocomplete="off" required>
    </div>
    <br>
    <div class="form-group">
        <label class="sr-only" for="class_1">班级</label>
        班级：<input type="text" class="form-control" id="class_1" name="class_1" placeholder="请输入班级" autocomplete="off" required>
    </div>
    <br>
