    ...
    <ul class="layui-nav right" lay-filter="">
        <li class="layui-nav-item">
            <a href="javascript:void(0)">
                ...
                欢迎您， ${admin.a_name} 管理员
            </a>
        </li>
        <li class="layui-nav-item to-index">
            <a>欢迎登陆</a></li>
        <li class="layui-nav-item lafitewu_exit to-index">
            <a href="LogoutServlet?status=admin"><i class="iconfont">&#xe704;</i>退出</a>
        </li>
    </ul>
</div>
<!-- 顶部结束 -->
    ...
    <div id="side-nav">
        <ul id="nav">
            ...
            <li>
                ...
                <ul class="sub-menu">
                    <li>
                        <a href="javascript:void(0)" onclick="window.maincontent.location.href='ExamManage?method=released'">
                            <cite>已发布的考试</cite></a>
                    </li>
                    <li>
                        <a href="javascript:void(0)" onclick="window.maincontent.location.href='ExamManage?method=done'">
                            <cite>已完成的考试</cite></a>
                    </li>
                </ul>
            </li>
            ...
            <li>
                <a href="javascript:void(0)" onclick="window.maincontent.location.href='./admin/teacher_guide.jsp'">
                    <i class="iconfont left-nav-li" lay-tips="教师管理">&#xe708;</i>
                    <cite>教师管理</cite>
                </a>
            </li>
            <li>
                <a href="javascript:void(0)" onclick="window.maincontent.location.href='./admin/adminPro.jsp'">
