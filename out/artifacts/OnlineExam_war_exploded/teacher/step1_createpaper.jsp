...
<form class="form-inline" role="form" style="text-align: center;" id="newpaper" action="./test.jsp" method="post">
    <div class="form-group">
        <label class="sr-only" for="papername">试卷名字</label>
        试卷名字：<input type="text" class="form-control" id="papername" style="width: 350px;" placeholder="请输入试卷名字" autocomplete="off">
    </div>
    <br>
    <div class="form-group">
        单选题：
    <select style="width: 100px; height: 30px;" id="danxuan">
        <%
    ...
    <div class="form-group">
        ...
        分数：<input type="text" class="form-control floatNum" id="score1" placeholder="请输入单选题分数" value="0" autocomplete="off">
    </div>
    <br>
    <div class="form-group">
        多选题：
        <select style="width: 100px; height: 30px;" id="duoxuan">
            <%
    ...
    <div class="form-group">
        ...
        分数：<input type="text" class="form-control floatNum" id="score2" placeholder="请输入多选题分数" value="0" autocomplete="off">
    </div>
    <br>
    <div class="form-group">
        判断题：
        <select style="width: 100px; height: 30px;" id="panduan">
            <%
    ...
    <div class="form-group">
        ...
        分数：<input type="text" class="form-control floatNum" id="score3" placeholder="请输入判断题分数" value="0" autocomplete="off">
    </div>
    <br>
    <div class="form-group">
        简答题：
        <select style="width: 100px; height: 30px;" id="jianda">
            <%
    ...
    <div class="form-group">
        ...
        分数：<input type="text" class="form-control floatNum" id="score4" placeholder="请输入简答题分数" value="0" autocomplete="off">
    </div>
    <br>
    <br>
    <h4 style="color: gray;">试卷总分：<input type="text" style="color: crimson; width: 50px;outline: none; border: none;" id="totalscore" value="0" readonly><span style="color: crimson;">分</span></h4>
