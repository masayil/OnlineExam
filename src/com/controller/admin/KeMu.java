...
@WebServlet(name = "KeMu",urlPatterns = {"/KeMu"})
public class KeMu extends HttpServlet {
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if(null==con) {
            ...
            ArrayList<Course> courses_list= QueryService.getCourseListService(con);
            dbpool.close(con);
            request.setAttribute("courses_list",courses_list);
            request.getRequestDispatcher("./admin/KeMu.jsp").forward(request,response);
        }
    }
