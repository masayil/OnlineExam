            ...
            <div class="ydc-panes">
                <div class="ydc-pane ydc-pane-clear" style="display:block;">
                    ...
                    <div class="ydc-reg-form-group clearfix">
                        <label>密码</label>
                        <div class="ydc-reg-form-input">
                            <input type="hidden" value="${admin.a_password}" id="mypassword">
...
<input type="hidden" id="t1" value=${admin.a_id}>
<!--  消息提示窗-->
