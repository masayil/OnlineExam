            ...
            <div class="test">
                    ...
                    <c:forEach var="paper1" items="${requestScope.paperbase1}" varStatus="status1">
                        <ul>
                            ...
                            <div class="test_content_nr_tt">
                                <font>第${status1.count}题</font>&emsp;(${paper1.score}分)&emsp;<font>${paper1.paperbase_title}</font>
                ...
                <div class="test_content_nr">
                    <c:forEach var="paper2" items="${requestScope.paperbase2}" varStatus="status2">
                        <ul>
                            <div class="test_content_nr_tt">
                                <font>第${status2.count}题</font> &emsp;(${paper2.score}分)&emsp;<font>${paper2.paperbase_title}</font>
                ...
                <div class="test_content_nr">
                    <c:forEach var="paper3" items="${requestScope.paperbase3}" varStatus="status3">
                        <ul>
                            <div class="test_content_nr_tt">
                                <font>第${status3.count}题</font> &emsp;(${paper3.score}分)&emsp;<font><font>${paper3.paperbase_title}</font>
                ...
                <div class="test_content_nr">
                    <c:forEach var="paper4" items="${requestScope.paperbase4}" varStatus="status4">
                        <ul>
                            <div class="test_content_nr_tt">
                                <font>第${status4.count}题</font> &emsp;(${paper4.score}分)&emsp;<font><font>${paper4.paperbase_title}</font>
                                <br>
