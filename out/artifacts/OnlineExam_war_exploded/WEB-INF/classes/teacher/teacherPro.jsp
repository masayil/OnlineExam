            ...
            <div class="ydc-panes">
                <div class="ydc-pane ydc-pane-clear" style="display:block;">
                    ...
                    <div class="ydc-reg-form-group clearfix">
                        <label>学院</label>
                        <div class="ydc-reg-form-input">
                            <label>${teacher.t_department}</label>
                        </div>
                    </div>
                    <br>
                    <div class="ydc-reg-form-group clearfix">
                        <label>密码</label>
                        <div class="ydc-reg-form-input">
                            <input type="hidden" value="${teacher.t_password}" id="mypassword">
