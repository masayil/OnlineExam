    ...
    <ul class="layui-nav right" lay-filter="">
        <li class="layui-nav-item">
            <a href="javascript:void(0)">
                ...
                欢迎您， ${teacher.t_name} 教师
            </a>
        </li>
        <li class="layui-nav-item to-index">
            <a>欢迎登陆</a></li>
        <li class="layui-nav-item lafitewu_exit to-index">
            <a href="LogoutServlet?status=teacher"><i class="iconfont">&#xe704;</i>退出</a>
        </li>
    </ul>
</div>
<!-- 顶部结束 -->
...
<div class="left-nav">
    <div id="side-nav">
        <ul id="nav">
            <li>
                <a href="javascript:void(0)" onclick="window.maincontent.location.href='FirstLoad?status=teacher'">
            ...
            <li>
                <a href="javascript:void(0)" onclick="window.maincontent.location.href='FindPaperBaseServlet'">
                    <i class="iconfont left-nav-li" lay-tips="试卷管理">&#xe708;</i>
                    <cite>试卷管理</cite>
                </a>
            </li>
            <li>
                <a href="javascript:void(0)" onclick="window.maincontent.location.href='./teacher/teacherPro.jsp'">
